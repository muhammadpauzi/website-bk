            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered">
                    <tbody>
                        ...
                        <tr>
                            <td class="text-bg-light fw-bold">Nama Tindakan</td>
                            <td>{{ $tindakan->name }}</td>
                        </tr>
                        <tr>
                            <td class="text-bg-light fw-bold">Min. Poin</td>
                            <td>
                                <span
                        ...
                        <tr>
                            <td class="text-bg-light fw-bold">Max. Poin</td>
                            <td>
                                <span
                                    class="badge text-primary-emphasis bg-primary-subtle border border-primary-subtle">{{
                        ...
                        <tr>
                            ...
                            <td>{!! nl2br($tindakan->description) !!}</td>
                        </tr>
                        <tr>
                            <td class="text-bg-light fw-bold">Ditambahkan pada</td>
                            <td>{{ $tindakan->created_at->format('d F Y H:i') }} ({{
                                $tindakan->created_at->diffForHumans() }})</td>
                        </tr>
                        <tr>
                            <td class="text-bg-light fw-bold">Diubah pada</td>
                            <td>{{ $tindakan->updated_at->format('d F Y H:i') }} ({{
                                $tindakan->updated_at->diffForHumans() }})</td>
                        </tr>
                        <tr>
